...
- Generated (UTC): `2026-09-21T11:09:49.060869+00:00`
...
| Avg latency cold (s) | 0.000152 | 0.000731 | — |
| Avg latency cached repeat (s) | — | 0.000576 | **1.268x vs cold hierarchical** |
...
| MRR | 0.8241 |
| nDCG@3 | 0.8348 |
| Avg retrieval stage latency (ms) | 0.1212 |
...
| `load_cached_tree` | 0.000031 |
| `transcribe` | 0.000013 |
| `semantic_chunk` | 0.000080 |
| `keyframe_select` | 0.000015 |
| `hierarchy_build` | 0.000031 |
