...
- Generated (UTC): `2026-08-31T11:53:49.798333+00:00`
...
- Caching: **1.29x** faster on repeat queries (100% hit rate).
- Ask latency (cold): p50 0.5 ms, p95 1.4 ms, p99 2.1 ms.
...
| Avg latency cold (s) | 0.000143 | 0.000643 | — |
| Avg latency cached repeat (s) | — | 0.000499 | **1.288x vs cold hierarchical** |
...
| MRR | 0.8241 |
| nDCG@3 | 0.8348 |
| Avg retrieval stage latency (ms) | 0.1110 |
...
| `load_cached_tree` | 0.000028 |
| `transcribe` | 0.000013 |
| `semantic_chunk` | 0.000075 |
| `keyframe_select` | 0.000013 |
| `hierarchy_build` | 0.000029 |
